...
## Discharge time series for Ventura and Santa Paula separately 
```{r}
...
ggplot(combined_current, aes(x = dateTime, y = discharge)) +
  ...
  labs(y = "Discharge (cubic ft/s)",
       ...
       subtitle = "2021-10-03 - 2021-10-05") 
```
...
```{r}
hh_data <- hh_data %>% 
  mutate(eng_percentage = speak_only_english / total)
